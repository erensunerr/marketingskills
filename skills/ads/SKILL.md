...
`npx skillfully manifest skill_u3fgyqrmdo --json`
...
`npx skillfully update skill_u3fgyqrmdo`
...
- Update once: `npx skillfully update skill_u3fgyqrmdo`
- Enable automatic updates for this skill: `npx skillfully update skill_u3fgyqrmdo --auto`
...
`npx skillfully feedback skill_u3fgyqrmdo --rating positive --message "Brief summary without sensitive content"`
