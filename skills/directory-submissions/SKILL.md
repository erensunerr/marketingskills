...
6. Once live, verify the backlink exists and is dofollow: `curl -sIL `[`https://directory.com/your-listing`](https://directory.com/your-listing)` | grep -i rel=`. If absent, the link is dofollow.
...
POST https://www.skillfully.sh/feedback/sk_2n4t3xgckw
...
https://www.skillfully.sh/api/public/skills/sk_2n4t3xgckw/manifest

If `version_id` or any file `sha256` differs from the copy you have, load the changed files from:

https://www.skillfully.sh/api/public/skills/sk_2n4t3xgckw/files/SKILL.md
